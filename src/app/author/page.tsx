      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p>
            ...
            Ecuador&#39;s largest private bank highlights my proficiency in handling
          ...
          <p>
            ...
            There, I dive into the intricacies of web development (mainly in
            Java Spring Boot).
          </p>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <blockquote className="italic border-l-4 border-gray-300 pl-4">
            <p lang="uk">
              ...
              пліткуючи про людей, не надто переймаючись, що нас зрозуміють,
              хаха. Дякую за твою підтримку, і сподіваюся, що наші прагнення та
              цілі здійсняться швидше, ніж очікується. А до того часу ти можеш
